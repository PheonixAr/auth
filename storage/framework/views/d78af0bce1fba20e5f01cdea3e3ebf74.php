            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('login')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="email" class="form-label">Username or Email Id</label>
                        ...
                        <div class="form-group">
                            <a style="text-decoration: none" href="forgot">Forgot your password
                                ?</a></p>
                        </div>
                        <div class="form-group">
...
<?php /**PATH /var/www/html/auth/resources/views/login.blade.php ENDPATH**/ ?>